...
const About = ({id}) => {
  return (
    <Fragment>
          ...
          <div id={id} className="d-flex col-sm-12 flex-wrap align-items-center bg-dark min-vh-100 pb-5 about">
            ...
            <div className=" col-lg-7 d-flex align-items-center flex-column">
              ...
              <p className="card-text pt-4 text-center text-white">
                ...
                mollitia soluta vero repellat debitis. Hic, illum provident?
                bis? Vero officia repudiandae impedit voluptatem reprehenderit
                quisquam perferendis tempora obcaecati. Sunt ducimus vero saepe
                officia quibusdam dolores.
              </p>
            </div>
          </div>
      ...
      <div className="d-flex text-center col-sm-12 col-lg-10 offset-lg-1 min-vh-100 justify-content-center  flex-column align-items-center bg-dark pb-5 ">
        <Fade>
          ...
          <p className="card-text p-4 text-white">
            ...
            adipisicing elit. Nobis dolorem sint doloremque mollitia soluta vero
            repellat debitis. Hic, illum provident? bis? Vero officia
